        ...
        >
          <div class="tick-modal-info-header">
            <div>
              <nav>
                              <router-link to="/">
                <button class="tick-modal-info-close" to="/">
                  <unicon
                    style="display: ruby"
                    name="angle-left"
                    fill="black"
          ...
          >
            ...
            >
              ...
              >
                <div class="tick-inputs4 mt-3">
                  <label for="pet-select"
                    >Лойиҳа<span style="color: #eb5757">*</span></label
                  >
                  <select
                    class="tick-modal-main-select"
                    style="
                    ...
                    @change="
                      getDepartmentNameAndSecuance(selectedProjectId);
              ...
              <div class="ticket-files-and-photo-block">
                <div class="ticket-upload-files-and-photo">
                  Расм юклаш
                  <div
                    class=""
                    style="
                  ...
                  >
                    ...
                    <div class="image-container" style="gap: 5px">
                      ...
                      >
                        ...
                        <button
                          class="tick-form-file-upload-close-btn"
                          style="border: none"
                        >
                          <img
                            src=""
                ...
                <div class="ticket-upload-files-and-photo">
                  ...
                  >
                    ...
                    <div class="image-container" style="gap: 5px">
                      <div
                        v-for="(uploadedFile, index) in filesRender"
                        :key="index"
                        class="tick-form-file-item"
                        style="position: relative"
                      >
                        <a
                          :href="`https://smart-office.uz/uploads/images/${uploadedFile.id}`"
                        >
                          <img
                            src="https://img.icons8.com/?size=100&id=FZtRbGC72S1r&format=png&color=000000"
                            class="uploaded-image"
                            style="border-radius: 6px !important"
                          />
                        </a>
              ...
              <div class="tick-modal-main-input tick-inputs1">
                ...
                <textarea
                  ...
                  :placeholder="ticketPlaceholderValue"
                  style="
                    color: rgba(99, 108, 121, 1) !important;
                    background: rgba(247, 247, 248, 1) !important;
                  "
              ...
              <div class="tick-modal-main-input tick-inputs2">
                ...
                <div class="tick-modal-files-upload tick-inputs6 mt-3">
                  <div class="tick-modal-files-title">
                    <div
                      class="tick-modal-info-header-btns"
                      style="
                        gap: 10px !important;
                        width: 100%;
                        display: flex;
                    ...
                    >
                      <button
                        class="tick-modal-info-close-btn tick-modal-info-btn"
                        @click="hide"
                      >
                        Ёпиш
                      </button>
                      <button
                        class="tick-modal-info-create-btn tick-modal-info-btn"
                        style="
...
export default {
  ...
  data() {
    return {
      ...
      filesRender: [],
      fileFormattedString: "",
      ticketPlaceholderValue: "Имкони борича кўпроқ тавсилотлар киритинг.",
    };
  },
  created() {
    // this.addCompressor();
  ...
  methods: {
    ...
    deleteUploadedFile(index) {
      ...
      this.formattedString = `{${this.images
        .map((img) => `'${img}'`)
        .join(",")}}`;
    },
    openFileInput() {
    ...
    addTicketNum(name, sequence) {
      ...
      if (isNaN(checkName)) {
        ...
        if (words.length == 1) {
          this.ticket_num =
            "T" + "-" + words[0][0].toUpperCase() + "-" + sequence;
        } else {
          if (words[1][0] == "(") {
            this.ticket_num =
              "T" + "-" + words[0][0].toUpperCase() + "-" + sequence;
